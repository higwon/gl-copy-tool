...
1. Release에서 `GLInputCopyTool-v0.4.0.zip`을 다운로드합니다.
2. zip 압축을 풉니다.
3. 압축을 푼 폴더 안의 `GLInputCopyTool-v0.4.0.exe`를 실행합니다.
...
```powershell
.\dist\GLInputCopyTool\GLInputCopyTool-v0.4.0.exe
```
...
- 한국, 네덜란드, 오스트리아, 헝가리, 폴란드, 체코, 슬로바키아 국가 양식을 지원합니다.
