...
1. Release에서 `GLInputCopyTool-v0.3.1.zip`을 다운로드합니다.
2. zip 압축을 풉니다.
3. 압축을 푼 폴더 안의 `GLInputCopyTool-v0.3.1.exe`를 실행합니다.
...
```powershell
.\dist\GLInputCopyTool\GLInputCopyTool-v0.3.1.exe
```
...
- Korea 표준, Netherlands GL Transactions Report, Austria FIBU Export 양식을 지원합니다.
...
- `Korea - Standard`
- `Netherlands - GL Transactions Report`
- `Austria - FIBU Export`
